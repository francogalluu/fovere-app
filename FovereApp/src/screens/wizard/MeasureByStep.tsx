  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        <Text style={styles.title}>Measure by</Text>
        <Text style={styles.sub}>Completion or quantity — coming in M6</Text>
        <Pressable style={styles.next} onPress={() => navigation.navigate('Target')}>
