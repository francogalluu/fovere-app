  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        <Text style={styles.title}>Name your habit</Text>
        <Text style={styles.sub}>Text input — coming in M6</Text>
        <Pressable style={styles.next} onPress={() => navigation.navigate('HabitIcon')}>
